package com.utfpr.donare.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFoundException(ResourceNotFoundException ex, HttpServletRequest request) {
        ...
        //todo ver uma lib de logs para os erros
    ...
    public ResponseEntity<ErrorResponse> handlerBadRequestException(UnauthorizedException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handlerBadRequestException(IllegalArgumentException ex, HttpServletRequest request) {
